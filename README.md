...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openmichrom-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13049&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openmichrom-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openmichrom` can be installed with:

```
conda install openmichrom
```

It is possible to list all of the versions of `openmichrom` available on your platform with:
